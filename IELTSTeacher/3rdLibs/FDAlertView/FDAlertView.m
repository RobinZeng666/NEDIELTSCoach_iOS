...
- (void)initTitleAndIcon {
    ...
    if (_title != nil && ![_title isEqualToString:@""]) {
        ...
        _titleLabel.font = [UIFont systemFontOfSize:TITLE_FONT_SIZE*AUTO_SIZE_SCALE_X];
...
- (void)initMessage {
    if (_message != nil) {
        ...
        _messageLabel.font = [UIFont systemFontOfSize:MESSAGE_FONT_SIZE*AUTO_SIZE_SCALE_X];
...
- (void)initAllButtons {
    if (_buttonTitleArray.count > 0) {
        ...
        for (NSString *buttonTitle in _buttonTitleArray) {
            ...
            button.titleLabel.font = [UIFont systemFontOfSize:BUTTON_FONT_SIZE*AUTO_SIZE_SCALE_X];
...
- (CGSize)getTitleSize {
    UIFont *font = [UIFont systemFontOfSize:TITLE_FONT_SIZE*AUTO_SIZE_SCALE_X];
...
- (CGSize)getMessageSize {
    UIFont *font = [UIFont systemFontOfSize:MESSAGE_FONT_SIZE*AUTO_SIZE_SCALE_X];
...
- (void)setTitleColor:(UIColor *)color fontSize:(CGFloat)size {
    ...
    if (size > 0) {
        _titleLabel.font = [UIFont systemFontOfSize:size*AUTO_SIZE_SCALE_X];
    }
}
...
- (void)setMessageColor:(UIColor *)color fontSize:(CGFloat)size {
    ...
    if (size > 0) {
        _messageLabel.font = [UIFont systemFontOfSize:size*AUTO_SIZE_SCALE_X];
    }
}
...
- (void)setButtonTitleColor:(UIColor *)color fontSize:(CGFloat)size atIndex:(NSInteger)index {
    ...
    if (size > 0) {
        button.titleLabel.font = [UIFont systemFontOfSize:size*AUTO_SIZE_SCALE_X];
    }
}
