...
- (id)init
{
    self = [super initWithFrame:CGRectMake(kScreenWidth / 2, kScreenHeight - 100, 100, 35)];
    if (self) {
        // Initialization code
...
- (void)showToastWithMessage:(NSString *)message showTime:(float)time
{
    ...
    CGSize size = [self getSizeOfStr:message font:[UIFont systemFontOfSize:16*AUTO_SIZE_SCALE_X]];
    
    self.font = [UIFont systemFontOfSize:16*AUTO_SIZE_SCALE_X];
